      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        <div className="text-center space-y-6 animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Expert product strategy from a <span className="text-white font-semibold">$210k Google PM</span> with 10+ years at Meta and Microsoft. 
            Get the roadmap, prioritization, and stakeholder alignment your company needs to scale—proven by billion-user products.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            <a
              href="#pricing"
              className="w-full sm:w-auto px-8 py-4 bg-white text-black font-semibold rounded-xl hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 text-center shadow-lg"
            ...
            <a
              ...
              aria-label="View how we help companies"
            >
              💡 See How I Help
            </a>
          </div>
